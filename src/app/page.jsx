...
const CollaborationSection = () => {
  return (
    <section className="bg-white">
      {/* Hero Banner */}
      <div className="bg-gradient-to-br from-blue-900 via-blue-800 to-orange-600 py-20 px-4">
            ...
            {collaborationPartners.map((partner, index) => (
              ...
              >
                <div className="p-6 flex flex-col flex-1">
                  ...
                  {/* Full name */}
                  <h4 className="text-base font-bold text-blue-900 leading-snug mb-2 group-hover:text-blue-700 transition-colors duration-300">
                    {partner.name}
                  </h4>
      ...
      {/* CTA Banner */}
      <div className="py-16 px-4 bg-gradient-to-br from-blue-50 to-orange-50">
        <div className="max-w-3xl mx-auto text-center">
